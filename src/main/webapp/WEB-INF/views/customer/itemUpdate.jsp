        ...
        <form method="post" name="productForm" action="/customers/productReg" enctype="multipart/form-data">
            ...
            <table width="500" border="1" cellspacing="0" cellpadding="0" align="center">           
                ...
                <tr>
                    ...
                    <td width="330">
                        <input type="text" size="40" maxlength="50" id="address2"  name="local" required="required" placeholder="농장주소를 입력하세요">
                ...
                <tr>
                    ...
                    <td width="330">
                        <input type="text" size="40" maxlength="50" id="address3" name="butchery" required="required" placeholder="도축장소를 입력하세요">
