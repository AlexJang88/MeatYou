...
#bigfont {
	...
	/* Change the font family as needed for bigfont */
...
#smallfont {
	...
	/* Change the font family as needed for smallfont */
}
	...
	<div class="main-container">
		<div class="category-menu">
			...
			<div class="vertical-menu">
				...
				<div class="vertical-menu-item">
					<a href="#" class="btn" class="btn" data-toggle="collapse"
						data-target="#check" id="bigfont">회원 관리</a>
					<div id="check" class="collapse">
						<a href="/customers/consumerList" class="btn" id="smallfont">구매회원</a><br />
						<a href="/customers/CouponList" class="btn" id="smallfont">쿠폰
							보유 회원</a>
					</div>
				</div>
				...
				<div class="vertical-menu-item">
					...
					<div id="go" class="collapse">
						<a href="/customers/delivering" class="btn" id="smallfont">주문접수 및 배송현황</a><br /> <a href="/customers/deliverout" class="btn" id="smallfont"> 주문 취소 </a><br />
					</div>
				</div>
				<div class="vertical-menu-item">
			...
			<td class="graph-and-summary">
				<table class="summary-table">
					...
					<tr height="30">
						...
						<td align="center"><input type="button" id="btn_kakao-paytwo" value="결제하기"></td>
					</tr>
				</table>
			</td>
		</table>
