...
<body>
    ...
    <center>
        ...
        <form method="post" name="productForm" action="/customers/itemRevisePro" >
            ...
            <table width="500" border="1" cellspacing="0" cellpadding="0" align="center">
                ...
                <tr>		      		      
			      ...
			      <td width="330" id="thumb">
			        <input type="text" size="40" maxlength="30" name="thumb" value="${lister.thumb}" placeholder="사진 나중에 추가할래"></td>
			   </tr>
                ...
                <tr>
				    ...
				    <td width="330">
				        <textarea name="pd_p_desc" rows="13" cols="40" required="required" placeholder="상품설명">${listerPD.pd_p_desc}</textarea>
				    </td>
				</tr>
