...
<%@ include file="../header.jsp" %>
    <link rel="stylesheet" href="/resources/admin/css/noticeUp.css"> <!-- 외부 스타일시트 추가 -->	
   <script>
...
<div style="display: flex; margin-top: 40px; margin-bottom: 50px;">
    <h2 id="getYear" class="out-table">공지사항 [ 수정하기 ]</h2><br/> 
</div>
<div class="main-container" >
	...
	<form method="post" action="/admin/noticeUpdateReg"
