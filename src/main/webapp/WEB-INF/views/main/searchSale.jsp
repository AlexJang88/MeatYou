			...
			<div class="container">
				...
				<div class="row">
					...
					<div id="store" class="col-md-9">
						...
						<div class="row">
							<!-- product -->
							<c:forEach var="sear" items="${searchSale}">
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<c:if test="${m_id != null}">
										...
										<form action="ShoppingCartInsertSearchSale" method="post" onsubmit="cart()">
							...
							<ul class="store-pagination">
								<c:if test="${count > 0}"> 
									<c:if test="${startPage > 10}">
										<li><a href="/main/searchSale?searchOption=total&search=${search}&pageNum${startPage-10}">[이전]</a></li>
									</c:if>
									<c:forEach var="i" begin="${startPage}" end="${endPage}">
										<li><a href="/main/searchSale?searchOption=total&search=${search}&pageNum=${i}">${i}</a></li>
									</c:forEach>
									<c:if test="${endPage < pageCount}">
										<li><a href="/main/searchSale?searchOption=total&search=${search}&pageNum${startPage+10}">[다음]</a></li>
									</c:if>	
