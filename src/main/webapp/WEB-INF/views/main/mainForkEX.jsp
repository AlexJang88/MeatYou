...
<%@ include file="../mainForkEXSort.jsp" %> 
			...
			<div class="container">
				...
				<div class="row">
					...
					<!-- /section title -->
						...
						<div class="row">
							<!-- product -->
							<c:forEach var="meat" items="${mainForkEX}">
						...
						<div class="store-filter clearfix">
							...
							<ul class="store-pagination">
								<c:if test="${price != null}">
									<c:if test="${count > 0}">
										<c:if test="${startPage > 10}">
											<li><a href="/main/mainForkEX?category=21&price=price&pageNum=${startPage-10}">[이전]</a></li>
										</c:if>
										<c:forEach var="i" begin="${startPage}" end="${endPage}">
											<li><a href="/main/mainForkEX?category=21&price=price&pageNum=${i}">${i}</a></li>
										</c:forEach>
										<c:if test="${endPage > pageCount}">
											<li><a href="/main/mainForkEX?category=21&price=price&pageNum=${startPage+10}">[다음]</a></li>
										</c:if>	
									</c:if>
								</c:if>
								...
								<c:if test="${sale != null}">
									<c:if test="${count > 0}">
										<c:if test="${startPage > 10}">
											<li><a href="/main/mainForkEX?category=21&sale=sale&pageNum=${startPage-10}">[이전]</a></li>
										</c:if>
										<c:forEach var="i" begin="${startPage}" end="${endPage}">
											<li><a href="/main/mainForkEX?category=21&sale=sale&pageNum=${i}">${i}</a></li>
										</c:forEach>
										<c:if test="${endPage > pageCount}">
											<li><a href="/main/mainForkEX?category=21&sale=sale&pageNum=${startPage+10}">[다음]</a></li>
										</c:if>	
									</c:if>
								</c:if>
								...
								<c:if test="${star != null}">
									<c:if test="${count > 0}">
										<c:if test="${startPage > 10}">
											<li><a href="/main/mainForkEX?category=21&star=star&pageNum=${startPage-10}">[이전]</a></li>
										</c:if>
										<c:forEach var="i" begin="${startPage}" end="${endPage}">
											<li><a href="/main/mainForkEX?category=21&star=star&pageNum=${i}">${i}</a></li>
										</c:forEach>
										<c:if test="${endPage > pageCount}">
											<li><a href="/main/mainForkEX?category=21&star=star&pageNum=${startPage+10}">[다음]</a></li>
										</c:if>	
									</c:if>
								</c:if>
								...
								<c:if test="${review != null}">
									<c:if test="${count > 0}">
										<c:if test="${startPage > 10}">
											<li><a href="/main/mainForkEX?category=21&review=review&pageNum=${startPage-10}">[이전]</a></li>
										</c:if>
										<c:forEach var="i" begin="${startPage}" end="${endPage}">
											<li><a href="/main/mainForkEX?category=21&review=review&pageNum=${i}">${i}</a></li>
										</c:forEach>
										<c:if test="${endPage > pageCount}">
											<li><a href="/main/mainForkEX?category=21&review=review&pageNum=${startPage+10}">[다음]</a></li>
										</c:if>	
									</c:if>
								</c:if>
								...
								<c:if test="${news != null}">
									<c:if test="${count > 0}">
										<c:if test="${startPage > 10}">
											<li><a href="/main/mainForkEX?category=21&news=news&pageNum=${startPage-10}">[이전]</a></li>
										</c:if>
										<c:forEach var="i" begin="${startPage}" end="${endPage}">
											<li><a href="/main/mainForkEX?category=21&news=news&pageNum=${i}">${i}</a></li>
										</c:forEach>
										<c:if test="${endPage > pageCount}">
											<li><a href="/main/mainForkEX?category=21&news=news&pageNum=${startPage+10}">[다음]</a></li>
										</c:if>	
									</c:if>
								</c:if>
							</ul>
