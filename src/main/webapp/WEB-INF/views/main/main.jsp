										...
										<div class="product">
											...
											<div class="product-body">
												...
												<div class="add-to-cart">
													...
													<button class="add-to-cart-btn" onclick="location.href='ShoppingCartInsert2?p_num=${p_num}&p_m_id=${mid}&shop_quantity=1'"><i class="fa fa-shopping-cart"></i>장바구니 담기</button>
												</div>
										</div>
										</c:forEach>
										<!-- /product -->
