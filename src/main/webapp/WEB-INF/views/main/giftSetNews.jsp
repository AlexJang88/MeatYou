						...
						<div class="store-filter clearfix">
							...
							<c:if test="${count > 0}">
								<c:if test="${startPage > 10}">
									<li><a href="/main/giftSetNews?pageNum=${startPage-10}">[이전]</a></li>
								</c:if>
								<c:forEach var="i" begin="${startPage}" end="${endPage}">
									<li><a href="/main/giftSetNews?pageNum=${i}">${i}</a></li>
								</c:forEach>
								<c:if test="${endPage > pageCount}">
									<li><a href="/main/giftSetNews?pageNum=${startPage+10}">[다음]</a></li>
								</c:if>	
