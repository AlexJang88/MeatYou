			...
			<div class="container">
				...
				<div class="row">
					...
					<!-- /section title -->
						...
						<div class="row">
							<!-- product -->
							<c:forEach var="meats" items="${mainMeatSort}">
							<div class="col-md-4 col-xs-6">
								<div class="product">
									<div class="product-img">
										<img src="../resources/file/product/${meats.p_num}/${meats.thumb}" >
						...
						<div class="store-filter clearfix">
							...
							<c:if test="${count > 0}">
								<c:if test="${startPage > 10}">
									<li><a href="/main/mainMeatSort?category=${category}&price=desc&pageNum=${startPage-10}">[이전]</a></li>
								</c:if>
								<c:forEach var="i" begin="${startPage}" end="${endPage}">
									<li><a href="/main/mainMeatSort?category=${category}&price=desc&pageNum=${i}">${i}</a></li>
								</c:forEach>
								<c:if test="${endPage > pageCount}">
									<li><a href="/main/mainMeatSort?category=${category}&price=desc&pageNum=${startPage+10}">[다음]</a></li>
								</c:if>	
