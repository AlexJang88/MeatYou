								...
								<div class="product">
									...
									<c:if test="${m_id != null}">
										<div class="add-to-cart">
											...
											<input type="hidden" name="category" value="${category}">
											<input type="hidden" name="price" value="desc">
											<button class="add-to-cart-btn"  onsubmit="cart()" onclick="location.href='ShoppingCartInsertMainMeat?p_num=${p_num}&m_id=${m_id}&shop_quantity=1&category=${category}&price=desc'"><i class="fa fa-shopping-cart"></i>장바구니 담기</button>
										</div>
									</c:if>
									<c:if test="${m_id == null}">
										<div class="add-to-cart">
