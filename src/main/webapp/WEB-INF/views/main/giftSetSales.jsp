			...
			<div class="container">
				...
				<div class="row">
					...
					<!-- /section title -->
						...
						<div class="row">
							<!-- product -->
							<c:forEach var="gift" items="${giftSetSales}">
							<div class="col-md-4 col-xs-6">
								<div class="product">
									<div class="product-img">
										<img src="../resources/file/product/${gift.p_num}/${gift.thumb}" >
										<div class="product-label">
											<div style="text-align : center;">
												<form>
													<input class="viewClass" type="button" value="미리 보기" onclick="openPopUp('${gift.p_num}','${gift.p_m_id}')"><br>
												</form>
											</div>
										</div>
									</div>
									...
									<c:if test="${m_id != null}">
										...
										<form action="ShoppingCartInsertgiftSet" method="post">
						...
						<div class="store-filter clearfix">
							...
							<c:if test="${count > 0}">
								<c:if test="${startPage > 10}">
									<li><a href="/main/giftSetSales?pageNum=${startPage-10}">[이전]</a></li>
								</c:if>
								<c:forEach var="i" begin="${startPage}" end="${endPage}">
									<li><a href="/main/giftSetSales?pageNum=${i}">${i}</a></li>
								</c:forEach>
								<c:if test="${endPage > pageCount}">
									<li><a href="/main/giftSetSales?pageNum=${startPage+10}">[다음]</a></li>
								</c:if>	
