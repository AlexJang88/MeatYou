			...
			<div class="container">
				...
				<div class="row">
					...
					<!-- /section title -->
						...
						<div class="row">
							<!-- product -->
							<c:forEach var="smenu" items="${setMenu}">
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="product-body">
										...
										<a href="../main/product?p_num=${smenu.p_num}&p_m_id=${smenu.p_m_id}"><h4 class="product-price">${smenu.p_price}</h4></a>
										...
										<div class="rating-avg">${smenu.star}
														<c:if test="${smenu.star <= 5.0 && smenu.star > 4.6}">
									...
									<c:if test="${m_id != null}">
										...
										<form action="ShoppingCartInsertsetMenu" method="post">
						...
						<div class="store-filter clearfix">
							...
							<c:if test="${count > 0}">
								<c:if test="${startPage > 10}">
									<li><a href="/main/setMenu?p_s_category=${p_s_category}&pageNum=${startPage-10}">[이전]</a></li>
								</c:if>
								<c:forEach var="i" begin="${startPage}" end="${endPage}">
									<li><a href="/main/setMenu?p_s_category=${p_s_category}&pageNum=${i}">${i}</a></li>
								</c:forEach>
								<c:if test="${endPage > pageCount}">
									<li><a href="/main/setMenu?p_s_category=${p_s_category}&pageNum=${startPage+10}">[다음]</a></li>
								</c:if>	
