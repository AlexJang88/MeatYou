...
public class CustomersController {
   ...
   public String home(Model model, Principal pc) {
      ...
      service.totalsumMoney(model, id);
   ...
   @RequestMapping("powerlinkpay") 
      public String powerlinkpay(Model model, int p_num, Principal pc, int co_num, int clickpay, String p_name, String thumb) { 
   ...
   public String productUpdateReg(HttpServletRequest req, ProductDTO productdto, MultipartFile thumbs) {
      
      String realPath=req.getServletContext().getRealPath("/resources/file/product/");
      service.productUpdateReg(realPath,productdto, thumbs);
      return "redirect:/customers/itemList";
   }
