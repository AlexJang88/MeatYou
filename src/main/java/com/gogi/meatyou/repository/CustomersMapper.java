...
public interface CustomersMapper {
   ...
   public int totalsumMoney(String id);//총누적매출액
   public List<customerGraphDTO> graph(customerGraphDTO cusgrDTO);  // 메인에 그래프
   ...
   public void itemadUP(ProductDTO productdto);//반품주소 업데이트
   public MemAddressDTO adressUP(int num);//반품주소
